...
export default function Home() {
  ...
  const [selectedTab, setSelectedTab] = React.useState("unites")
  const isMobile = useIsMobile()

  // Function to render the appropriate content based on selection
